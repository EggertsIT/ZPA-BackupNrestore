"""Backup manifest and validation helpers for ZPA backup and restore workflows."""
...
from zpa_resources import MIGRATION_ORDER, READ_ONLY_REFERENCE_RESOURCES, RESOURCES, migration_order_issues
...
def validate_backup(backup: dict[str, Any], *, strict: bool = False) -> list[str]:
    ...
    expected_digest = backup_digest(backup)
